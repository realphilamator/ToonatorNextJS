...
export async function generateMetadata() {
  const t = await getTranslations('metadata.static');
      ...
      <div id="content">
        <div className="content_left">
          <h1>
            ...
            {" | "}
            <a href="/static" className="nmenu selected">{t('staticLabel')}</a>
            {" | "}
            <a href="/sandbox" className="nmenu">{t('sandbox')}</a>
          </h1>

          <UrlPaginator basePath="/static" currentPage={page} totalPages={totalPages} />
